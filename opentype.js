 ...
 */
 ...
 //This file has been modified by Jeremy Clark which fixed a bug whereby invalid or empty objects could not be converted/encoded correctly.
...
(function (global, factory) {
	...
	*****/
	...
	/**
	 * Converts a `opentype.Font` into an `NodeBuffer`
	 * @return {NodeBuffer}
	 */
	Font.prototype.ToNodeBuffer = function() {
	    return arrayBufferToNodeBuffer(this.toArrayBuffer());
	};
	...
	function loadFromUrlNode(url, callback) {
        const axios = require("axios");
        axios.get(url, {responseType: 'arraybuffer'}).then(function (response) {
	        callback(null, nodeBufferToArrayBuffer(response.data));
        }).catch(err => {
	...
	function load(url, callback, opt) {
	    ...
	    var loadFn = isNode$$1 ? loadFromUrlNode : loadFromUrl;
